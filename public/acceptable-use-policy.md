...
- make automated decisions without human review about the eligibility of individual consumers for financial products and creditworthiness, or decisions regarding eligibility of individual consumers for housing, including leases and home loans;
- make automated decisions about the employability of individuals or other employment determinations without human review;
...
Some use cases pose an elevated risk of harm because they influence domains that are vital to public welfare and social equity. “High-Risk Use Cases” include, without limitation, use cases related to legal, healthcare, employment, housing, finance, insurance, education admission, as well as any other use case that qualifies as high-risk under applicable laws (such as the EU AI Act).

As such, for any High-Risk Use Cases, we require that you implement the additional safety measures listed below:
