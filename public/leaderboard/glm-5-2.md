...
* Search Intelligence Score: **54.3** (#18 in Search Intelligence)
* Without search: 18.4 · Lift from search +35.9
* Cost per 1K tasks: $66.6 (below the median score of 60.4, so not ranked on cost)
* Time per task: 301s
* Lab: Z.ai · Model id: z-ai/glm-5.2
