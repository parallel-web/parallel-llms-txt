...
<Update label="January 28, 2026">
  ...
  Learn more about combining public web research with [login gated private data](https://docs.parallel.ai/integrations/browseruse).
</Update>
...
<Update label="January 21, 2026">
  ...
  Learn more about [Monitor with Structured Outputs](https://docs.parallel.ai/monitor-api/monitor-structured-outputs).
</Update>
...
<Update label="January 15, 2026">
  ...
  Learn more about [Chat API Research Models](https://docs.parallel.ai/chat-api/chat-quickstart#choosing-the-right-model).
</Update>
...
<Update label="January 6, 2026">
  ...
  Learn more about [Source Policy](https://docs.parallel.ai/resources/source-policy#configuration).
</Update>
...
<Update label="December 16, 2025">
  ...
  Learn more about [Basis](https://docs.parallel.ai/task-api/guides/access-research-basis#basis).
</Update>
...
<Update label="December 10, 2025">
  ...
  Learn more about [Processors](https://docs.parallel.ai/task-api/guides/choose-a-processor).
</Update>
