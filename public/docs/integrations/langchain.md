...
This integration provides LangChain integrations for Parallel, enabling real-time web research and AI capabilities through an OpenAI-compatible interface.
...
1. Get your API key from [Parallel](https://app.parallel.ai)
