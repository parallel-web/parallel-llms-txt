...
<Note>ClawHub does not currently support verified or "official" publisher accounts. The Parallel skills are published under [@NormallyGaussian](https://clawhub.ai/normallygaussian).</Note>
...
* **Extract** — "Read this URL and summarize it: [https://example.com/article](https://example.com/article)"
