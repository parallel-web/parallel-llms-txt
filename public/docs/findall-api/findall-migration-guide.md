...
<CodeGroup>
  ...
  requests.post(
      ...
      json={
          "processor": "lite",
          "enrichment_output_schema": ingest_data.get("enrichment_output_schema")
      }
  )
...
* **[Generators and Pricing](/findall-api/core-concepts/findall-generator-pricing)**: Learn about V1 pricing model
