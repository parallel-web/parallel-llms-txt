...
**Don't use for historical research**: Monitor is designed to track *new* updates as they happen, not to retrieve past news. Use [Deep Research](/task-api/examples/task-deep-research) for historical queries.
