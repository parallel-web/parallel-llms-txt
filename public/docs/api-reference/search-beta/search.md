      ...
      properties:
        mode:
          ...
          description: >-
            ...
            `one-shot` returns more comprehensive results and longer excerpts to
            answer questions from a single response, while `agentic` returns
      ...
      properties:
        max_chars_per_result:
          ...
          description: >-
            ...
            maximize relevance and token efficiency, but will never contain
            fewer than 1000 characters per result.
        max_chars_total:
          anyOf:
            - type: integer
            - type: 'null'
          ...
          description: >-
            ...
            limit to maximize relevance and token efficiency, but will never
            contain fewer than 1000 characters per result.This overall limit
            applies in addition to max_chars_per_result.
      type: object
