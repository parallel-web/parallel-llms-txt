      ...
      application/json:
        schemaArray:
          - type: object
              ...
              metadata:
                allOf:
                  - anyOf:
                    ...
                    title: Metadata
                    description: >-
                      Updated user-provided metadata. This field is returned in
                      webhook notifications, enabling you to map responses to
            ...
            refIdentifier: '#/components/schemas/UpdateMonitorRequest'
        examples:
          example:
            value:
              cadence: daily
