...
````yaml /public-openapi.json post /v1alpha/monitors/{monitor_id}
openapi: 3.1.0
info:
  title: Parallel API
    ...
    UpdateMonitorRequest:
      properties:
        ...
        frequency:
          ...
          title: Frequency
          description: >-
            Updated frequency of the monitor. Format: '<number><unit>' where
            unit is 'h' (hours), 'd' (days), or 'w' (weeks). Must be between 1h
            and 30d (inclusive).
          examples:
            - 1d
            - 1w
        ...
        metadata:
          ...
          title: Metadata
          description: >-
            Updated user-provided metadata. This field is returned in webhook
            notifications, enabling you to map responses to corresponding
