...
````yaml /public-openapi.json get /v1alpha/monitors/list
openapi: 3.1.0
info:
  title: Parallel API
  ...
  /v1alpha/monitors/list:
    get:
      ...
      description: >-
        ...
        Returns active monitors for the authenticated client, sorted by
        `created_at`
        ...
        - name: cursor
          ...
          schema:
            anyOf:
              ...
              - type: 'null'
            description: >-
              Opaque pagination token returned as `next_cursor` in a previous
              response. Omit to start from the most recently created monitor.
            title: Cursor
          description: >-
            Opaque pagination token returned as `next_cursor` in a previous
            response. Omit to start from the most recently created monitor.
          ...
          content:
            application/json:
              ...
              example:
                ...
                next_cursor: >-
                  eyJjYSI6ICIyMDI1LTA0LTIzVDIwOjIxOjQ4WiIsICJtaWQiOiAibW9uXzEyMyJ9
        '401':
...
components:
  schemas:
    PaginatedMonitorResponse:
      ...
      description: >-
        Paginated list of monitors with an opaque cursor for fetching the next
        page.
    ErrorResponse:
      properties:
        type:
