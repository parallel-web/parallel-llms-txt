  ...
  /v1alpha/monitors:
    get:
      ...
      description: >-
        ...
        Supports pagination using `monitor_id` as a cursor and `limit` to
        control
        ...
        - name: monitor_id
          ...
          schema:
            anyOf:
              ...
              - type: 'null'
            description: >-
              Monitor ID to start listing after (for pagination). Returns
              monitors starting with this ID in lexicographic order.
            title: Monitor Id
          description: >-
            Monitor ID to start listing after (for pagination). Returns monitors
            starting with this ID in lexicographic order.
        - name: limit
          in: query
          required: false
          schema:
            anyOf:
              ...
              - type: 'null'
            description: >-
              Maximum number of monitors to return. Defaults to returning all
              monitors.
            title: Limit
          description: >-
            Maximum number of monitors to return. Defaults to returning all
