...
> List events for a monitor from up to the last 300 runs.

Retrieves events from monitor runs, including events with errors and
        ...
        lookback_period:
          schema:
            - type: string
              ...
              description: >-
                Lookback period to fetch events from. Sample values: `10d`,
                `1w`. A minimum of 1 day is supported and with one day
                increments. Use `d` for days, `w` for weeks.
              default: 10d
      header: {}
      cookie: {}
    body: {}
