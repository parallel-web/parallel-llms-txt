  ...
  /v1alpha/monitors:
    post:
      ...
      description: >-
        ...
        specified cadence (hourly, daily, or weekly). The monitor runs once at
        creation and
    ...
    CreateMonitorRequest:
      properties:
        ...
        metadata:
          ...
          title: Metadata
          description: >-
            User-provided metadata stored with the monitor. This field is
            returned in webhook notifications and GET requests, enabling you to
            map responses to corresponding objects in your application. For
            example, if you are building a Slackbot that monitors changes, you
            could store the Slack thread ID here to properly route webhook
            responses back to the correct conversation thread.
          examples:
