...
<Warning>
  **15,000 character limit:** The combined length of your task specification AND input data cannot exceed 15,000 characters. This includes:
...
| Task spec size           | error | 10,000 chars     | Maximum length of the task specification alone                 |
| **Total size**           | error | **15,000 chars** | **Maximum combined length of task specification + input data** |
