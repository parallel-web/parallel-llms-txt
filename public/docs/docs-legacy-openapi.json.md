  ...
  "paths": {
    "/v1beta/search": {
      "post": {
        ...
        "summary": "Search",
        "description": "Searches the web.\n\nThis endpoint remains supported for existing integrations. For new integrations,\nuse the [V1 Search API reference](https://docs.parallel.ai/api-reference/search/search)\nand see the [migration guide](https://docs.parallel.ai/search/search-migration-guide).",
    ...
    "/v1beta/extract": {
      "post": {
        ...
        "summary": "Extract",
        "description": "Extracts relevant content from specific web URLs.\n\nThis endpoint remains supported for existing integrations. For new integrations,\nuse the [V1 Extract API reference](https://docs.parallel.ai/api-reference/extract/extract)\nand see the [migration guide](https://docs.parallel.ai/extract/extract-migration-guide).",
      ...
      "DeprecatedCreateMonitorRequest": {
        "properties": {
          ...
          "source_policy": {
            ...
            "description": "Source policy governing included and excluded domains and domain/path prefixes in web search results.",
            "examples": [
              {
                "include_domains": [
                  "wikipedia.org",
      ...
      "ExcerptSettings": {
        "properties": {
          ...
          "max_chars_total": {
            ...
            "description": "Optional upper bound on the total number of characters to include across all urls. Results may contain fewer characters than this limit to maximize relevance and token efficiency. This overall limit applies in addition to max_chars_per_result."
          }
        },
        "type": "object",
      ...
      "SearchRequest": {
        "properties": {
          ...
          "source_policy": {
            ...
            "description": "Optional source policy governing included and excluded domains, paths, and dates in search results."
          },
          "fetch_policy": {
            "anyOf": [
              {
