...
Today, we’re announcing significant latency improvements to the Parallel Task API, available via a new suite of Lower-latency [Processors](https://docs.parallel.ai/task-api/guides/choose-a-processor). These latency improvements enable high-quality structured web research across a broad range of price points, compute levels, _and_ speed.
