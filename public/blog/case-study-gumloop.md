...
[Gumloop](https://www.gumloop.com/) is an AI automation framework that combines data, apps, and AI in a drag and drop interface. With Gumloop, any person regardless of technical ability, can build time-saving workflows that are always grounded in real-world information via the Parallel Task API.
