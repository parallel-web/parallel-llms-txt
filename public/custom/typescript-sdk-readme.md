...
[![NPM version]()](https://npmjs.org/package/parallel-web) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/parallel-web)
...
apiKey: process.env['PARALLEL\_API\_KEY'], // This is the default and can be omitted
});
...
1. Via the `PARALLEL\_LOG` environment variable
