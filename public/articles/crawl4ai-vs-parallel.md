...
Crawl4AI has no SLA, no status page, and no support contract beyond community channels and a sponsorship programme. That is normal for open source and reasonable. It just has to be a conscious choice rather than a discovery during an incident.
